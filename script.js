  const NODES = [
  {
    ...
    body:
  `白桦小学数字纪念馆将于今日 08:00 自动开馆。

  维护过程中，工作人员从旧资料柜里找到四枚已经脱落的导航印章。印章背面似乎刻有数字，但必须按照旧馆藏系统的顺序重新装回，系统才会读取。

  旧维护便签：

  ① 先清点留下来的东西。人走以后，它们反而越来越多。

  ② 再去看那些不会变老的脸。他们离开时几岁，如今仍是几岁。

  ③ 看清脸以后，才能把名字还给他们。

  ④ 最后翻开校史——只有活着的东西，才需要年份。`,

    objective: "按照旧维护便签，将四枚导航印章放回正确顺序。",
  ...
  },
  {
    ...
    "type": "公开展厅 / 异常访问记录",
    "time": "06:16",
    "body": "1912：白桦小学成立。\n1931：二号教学楼扩建。\n1946：学校列入战后教育恢复计划。\n\n时间轴上的“1946 年 9 月 1 日”无法正常打开。维护日志显示，有人在昨夜反复把鼠标停在这个日期上。系统只留下四段缓存，但顺序被打乱：\n\n00:03:14　照片\n00:03:09　这不是\n00:03:17　目录里\n00:03:11　复课\n\n请按日志发生的时间恢复这句话。",
    "objective": "按照时间戳排列四段缓存，恢复昨夜访客留下的话。",
    "puzzle": {
      "type": "order",
      "items": [
        "00:03:14　照片",
    ...
    "hints": [
      "不要按照按钮现在的排列读，要看每段前面的时间。",
      "时间顺序是 09、11、14、17 秒。",
      "恢复出的句子是：这不是复课照片，照片在目录里。"
    ]
  },
  {
    "id": "n3",
    ...
    "type": "维护后台 / 目录校验",
    "time": "06:20",
    "body": "目录中有四张同批扫描的底片。正常情况下，公开标题、底片背签和修订次数应当对应；只有一项被人强行改成了“复课”照片。\n\n17｜公开标题：校门修缮　｜背签：校门东侧　｜修订：0\n18｜公开标题：操场东侧　｜背签：操场东侧　｜修订：0\n19｜公开标题：复课第一日｜背签：二年甲班，勿公开｜修订：4\n20｜公开标题：教师办公室｜背签：教师办公室｜修订：0\n\n昨夜缓存写着：“这不是复课照片，照片在目录里。”请选择标题与原始背签冲突、且被反复改写的记录。",
    "objective": "同时检查公开标题、底片背签和修订次数，找出被伪装成复课照片的一项。",
    "puzzle": {
      "type": "choice",
      "options": [
        "17｜校门修缮",
